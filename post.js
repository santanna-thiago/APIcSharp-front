const tabelaDados = document.querySelector('.tabelaDados');
        ...
        const formulario = document.querySelector('.formFormulary')
            ...
            try {
                ...
                await creatCustomer(nameValue, cpfValue, genderValue, statusValue, typeValue);
        ...
        const creatCustomer = (nameValue, cpfValue, genderValue, statusValue, typeValue) => {
            return fetch(`https://localhost:7040/api/Customer`, {
                method: 'POST',
                headers: {
